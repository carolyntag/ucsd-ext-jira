...
public final class Constants {
    ...
    public static final String SEARCH_INPUT = "//span[@aria-label='Search (/)']";
    ...
    public static final String SEARCH_PICKER_INPUT ="//input[@type='text' and @placeholder='Search']";

    // BUTTON Elements
    public static final String CANCEL_BUTTON = "//a[@class='cancel' and (contains(text(),'Cancel'))]";
